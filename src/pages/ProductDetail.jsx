        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center border rounded-2xl w-fit">
                <button
                  ...
                  className="w-12 h-12 text-2xl hover:bg-gray-100 rounded-l-2xl"
                >
                  -
                </button>
                ...
                <button
                  ...
                  className="w-12 h-12 text-2xl hover:bg-gray-100 rounded-r-2xl"
                >
                  +
                </button>
              </div>
            ...
            <div className="flex gap-4 mb-10">
              ...
              <button className="flex-1 py-4 rounded-2xl border-2 border-gray-900 font-bold text-lg hover:bg-gray-900 hover:text-white transition">
                ADD TO CART
              </button>
            </div>
